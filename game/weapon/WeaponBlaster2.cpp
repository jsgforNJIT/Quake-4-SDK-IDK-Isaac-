...
class rvWeaponBlaster2 : public rvWeapon {
public:

	CLASS_PROTOTYPE( rvWeaponBlaster2 );

	rvWeaponBlaster2 ( void );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( rvWeaponBlaster2 );
};

CLASS_DECLARATION( rvWeapon, rvWeaponBlaster2 )
END_CLASS
...
================
*/
rvWeaponBlaster2::rvWeaponBlaster2 ( void ) {
}
...
================
*/
bool rvWeaponBlaster2::UpdateFlashlight ( void ) {
	if ( !wsfl.flashlight ) {
		return false;
	}
...
================
*/
void rvWeaponBlaster2::Flashlight ( bool on ) {
	owner->Flashlight ( on );
...
================
*/
bool rvWeaponBlaster2::UpdateAttack ( void ) {
	// Clear fire forced
	if ( fireForced ) {
		if ( !wsfl.attack ) {
			fireForced = false;
...
================
*/
void rvWeaponBlaster2::Spawn ( void ) {
...
================
*/
void rvWeaponBlaster2::Save ( idSaveGame *savefile ) const {
...
================
*/
void rvWeaponBlaster2::Restore ( idRestoreGame *savefile ) {
...
================
*/
void rvWeaponBlaster2::PreSave ( void ) {
...
================
*/
void rvWeaponBlaster2::PostSave ( void ) {
}
...
CLASS_STATES_DECLARATION ( rvWeaponBlaster2 )
	STATE ( "Raise",						rvWeaponBlaster2::State_Raise )
	STATE ( "Lower",						rvWeaponBlaster2::State_Lower )
	STATE ( "Idle",							rvWeaponBlaster2::State_Idle)
	STATE ( "Charge",						rvWeaponBlaster2::State_Charge )
	STATE ( "Charged",						rvWeaponBlaster2::State_Charged )
	STATE ( "Fire",							rvWeaponBlaster2::State_Fire )
	STATE ( "Flashlight",					rvWeaponBlaster2::State_Flashlight )
...
================
*/
stateResult_t rvWeaponBlaster2::State_Raise( const stateParms_t& parms ) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};	
...
================
*/
stateResult_t rvWeaponBlaster2::State_Lower ( const stateParms_t& parms ) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
================
*/
stateResult_t rvWeaponBlaster2::State_Idle ( const stateParms_t& parms ) {	
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};	
...
================
*/
stateResult_t rvWeaponBlaster2::State_Charge ( const stateParms_t& parms ) {
	enum {
		CHARGE_INIT,
		CHARGE_WAIT,
	};	
...
================
*/
stateResult_t rvWeaponBlaster2::State_Charged ( const stateParms_t& parms ) {
	enum {
		CHARGED_INIT,
		CHARGED_WAIT,
	};	
...
================
*/
stateResult_t rvWeaponBlaster2::State_Fire ( const stateParms_t& parms ) {
	enum {
		FIRE_INIT,
		FIRE_WAIT,
	};	
...
================
*/
stateResult_t rvWeaponBlaster2::State_Flashlight ( const stateParms_t& parms ) {
	enum {
		FLASHLIGHT_INIT,
		FLASHLIGHT_WAIT,
	};	
